...
class PoseSolver {
  static solve(lm3d, lm2d, { runtime = "mediapipe", video = null, imageSize = null, enableLegs = true } = {}) {
    ...
    const rightHandOffscreen = ((_a = lm3d[15].visibility) != null ? _a : 0) < 0.23 || 0.995 < lm2d[15].y;
    const leftHandOffscreen = ((_b = lm3d[16].visibility) != null ? _b : 0) < 0.23 || 0.995 < lm2d[16].y;
    const leftFootOffscreen = ((_c = lm3d[23].visibility) != null ? _c : 0) < 0.63;
    const rightFootOffscreen = ((_d = lm3d[24].visibility) != null ? _d : 0) < 0.63;
    //console.log(lm3d[15].y > 0.1, ((_a = lm3d[15].visibility) != null ? _a : 0) < 0.23, 0.995 < lm2d[15].y);
