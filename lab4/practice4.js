...
const camera_ar = new THREE.PerspectiveCamera( 45, render_w/render_h, 1, 1000 );
...
loader.load( '../models/gltf/Xbot.glb', function ( gltf ) {
    ...
    model.traverse( function ( object ) {
        ...
        if ( object.isBone ) {
          ...
          bones.push(object);
          //console.log(object);
          //if(object.name == "mixamorigHead" || object.name == "mixamorigHeadTop_End" || object.name == "mixamorigLeftEye" || object.name == "mixamorigRightEye" || object.name == "mixamorigSpine2") 
...
const test_points = new THREE.Points(new THREE.BufferGeometry(), new THREE.PointsMaterial({ color: 0xFF0000, size: 0.5, sizeAttenuation: true }));
...
const test_new_points = new THREE.Points(new THREE.BufferGeometry(), new THREE.PointsMaterial({ color: 0x0000FF, size: 0.5, sizeAttenuation: true }));
test_new_points.geometry.setAttribute('position', new THREE.BufferAttribute(new Float32Array(3 * 3), 3));
...
function onResults2(results) {
  ...
  }
  {
    ...
    threeMpPose.transformToWorld(camera_ar, 10);
